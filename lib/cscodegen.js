...
(function() {
  ...
  (function(exports) {
    ...
    return exports.generate = generate = function(ast, options) {
      var a, absNum, allNew, allReassign, arg, args, c, comprehension, exp, expression_, finallyBody, findIds, flag, hasAlternate, i, isMultiline, key_, left, m, memberAccessOps, members_, needsParens, nonLiteral, output, p, parameters, parent, parentClassName, prec, right, s, sep, src, state, type, usedAsExpression, v, vars, _alternate, _argList, _args, _assg, _assignee, _block, _body, _by, _catchAssg, _catchBody, _condition, _conditions, _consequent, _ctor, _expr, _expression, _exprs, _filter, _finally, _firstAssg, _flags, _fn, _indexingExpr, _left, _main, _mainPart, _mid, _nameAssg, _op, _own, _paramList, _parent, _rangeLeft, _rangeRight, _ref, _ref1, _ref2, _ref3, _right, _s, _secondAssg, _step, _symbol, _target;
      if (options == null) {
        options = {};
      }
      if (!(ast != null)) {
      ...
      src = (function() {
        var _i, _j, _len, _len1, _ref10, _ref11, _ref12, _ref13, _ref14, _ref15, _ref16, _ref17, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
        switch (ast.className) {
          case 'Program':
          ...
          case 'NewOp':
            ...
            args = (function() {
              ...
              _ref11 = ast["arguments"];
              _results = [];
              for (i = _k = 0, _len2 = _ref11.length; _k < _len2; i = ++_k) {
                a = _ref11[i];
          ...
          case 'SoakedFunctionApplication':
            ...
            if (ast.className === 'FunctionApplication' && ast["arguments"].length === 0 && ((_ref11 = (_ref12 = options.ancestors[1]) != null ? _ref12.className : void 0) !== 'UnaryExistsOp' && _ref11 !== 'SoakedMemberAccessOp')) {
              return "" + _fn + "!";
            } else {
              args = (function() {
                var _k, _len2, _ref13, _results;
                _ref13 = ast["arguments"];
                _results = [];
                for (i = _k = 0, _len2 = _ref13.length; _k < _len2; i = ++_k) {
                  a = _ref13[i];
                  arg = generate(a, options);
          ...
          case 'SoakedDynamicProtoMemberAccessOp':
            ...
            if (ast.className === 'DynamicMemberAccessOp' && ((_ref13 = ast.indexingExpr.className) === 'String' || _ref13 === 'Int')) {
          ...
          case 'Slice':
            ...
            if (ast.className === 'Slice') {
              ...
              if (_main) {
                ...
                return parens("if (ref$$ = " + _left + ") > (ref1$$ = " + _right + ") then [ref$$ " + _mid + " ref1$$ by -1] else [ref$$ " + _mid + " ref1$$]");
              } else {
          ...
          case 'ForOf':
            ...
            if (type === 'of') {
              _ref15 = [_secondAssg, _firstAssg], _firstAssg = _ref15[0], _secondAssg = _ref15[1];
            }
            if (_secondAssg) {
            ...
            comprehension = false;
            _body = ast.body ? (comprehension = ((_ref16 = ast.body.statements) != null ? _ref16.length : void 0) === 1 && usedAsExpression && 'For' !== ast.body.statements[0].className.slice(0, 3), generate(ast.body, options)) : 'void';
          ...
          case 'Class':
            ...
            if (((_ref17 = ast.nameAssignee) != null ? _ref17.className : void 0) === 'MemberAccessOp') {
