...
(function() {
  ...
  (function(exports) {
    ...
    return exports.generate = generate = function(ast, options) {
      var a, absNum, arg, args, exp, expression_, flag, hasAlternate, i, isMultiline, key_, m, memberAccessOps, members_, needsParens, p, parameters, parent, parentClassName, prec, s, sep, src, state, usedAsExpression, _alternate, _argList, _args, _assignee, _block, _body, _consequent, _ctor, _expr, _exprs, _flags, _fn, _indexingExpr, _left, _mid, _op, _paramList, _ref, _ref1, _right, _symbol, _target;
      if (options == null) {
        options = {};
      }
      needsParens = false;
      ...
      src = (function() {
        var _i, _len, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8;
        switch (ast.className) {
          case 'Program':
