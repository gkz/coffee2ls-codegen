...
(function() {
  ...
  (function(exports) {
    ...
    return exports.generate = generate = function(ast, options) {
      var a, absNum, arg, args, expression_, flag, hasAlternate, i, isMultiline, key_, m, memberAccessOps, members_, needsParens, p, parameters, parent, parentClassName, prec, s, sep, src, state, usedAsExpression, _alternate, _argList, _args, _assignee, _block, _body, _consequent, _ctor, _expr, _exprs, _flags, _fn, _indexingExpr, _left, _op, _paramList, _ref, _ref1, _right, _symbol;
      if (options == null) {
        options = {};
      }
      needsParens = false;
