...
(function() {
  ...
  (function(exports) {
    ...
    return exports.generate = generate = function(ast, options) {
      var a, absNum, arg, args, exp, expression_, flag, hasAlternate, i, isMultiline, key_, m, memberAccessOps, members_, needsParens, p, parameters, parent, parentClassName, prec, s, sep, src, state, type, usedAsExpression, _alternate, _argList, _args, _assignee, _block, _body, _consequent, _ctor, _expr, _exprs, _filter, _firstAssg, _flags, _fn, _indexingExpr, _left, _mid, _op, _own, _paramList, _rangeLeft, _rangeRight, _ref, _ref1, _right, _secondAssg, _step, _symbol, _target;
      if (options == null) {
        options = {};
      }
      needsParens = false;
      ...
      src = (function() {
        ...
        switch (ast.className) {
          ...
          case 'ForOf':
            ...
            _body = ast.body ? generate(ast.body, options) : '';
            return "for " + _own + _firstAssg + _secondAssg + " " + _target + _step + _filter + "\n" + (indent(_body));
          default:
