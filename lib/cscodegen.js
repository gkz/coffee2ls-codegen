...
(function() {
  ...
  (function(exports) {
    ...
    return exports.generate = generate = function(ast, options) {
      ...
      src = (function() {
        var _i, _len, _ref10, _ref11, _ref12, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
        switch (ast.className) {
          case 'Program':
          ...
          case 'ForOf':
            ...
            if (type === 'of') {
              _ref11 = [_secondAssg, _firstAssg], _firstAssg = _ref11[0], _secondAssg = _ref11[1];
            }
            if (_secondAssg) {
            ...
            comprehension = false;
            _body = ast.body ? (comprehension = ((_ref12 = ast.body.statements) != null ? _ref12.length : void 0) === 1 && usedAsExpression && 'For' !== ast.body.statements[0].className.slice(0, 3), generate(ast.body, options)) : 'void';
