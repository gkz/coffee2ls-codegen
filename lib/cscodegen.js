...
(function() {
  ...
  (function(exports) {
    ...
    return exports.generate = generate = function(ast, options) {
      var a, absNum, allNew, allReassign, arg, args, c, comprehension, exp, expression_, finallyBody, findIds, flag, hasAlternate, i, isMultiline, key_, left, m, memberAccessOps, members_, needsParens, output, p, parameters, parent, parentClassName, prec, right, s, sep, src, state, type, usedAsExpression, v, vars, _alternate, _argList, _args, _arrPart, _assignee, _block, _body, _by, _catchAssg, _catchBody, _condition, _conditions, _consequent, _ctor, _expr, _expression, _exprs, _filter, _finally, _firstAssg, _flags, _fn, _indexingExpr, _left, _mainPart, _mid, _nameAssg, _op, _own, _paramList, _parent, _rangeLeft, _rangeRight, _ref, _ref1, _ref2, _ref3, _right, _secondAssg, _step, _symbol, _target;
      if (options == null) {
        options = {};
      }
      if (!(ast != null)) {
        ...
        switch (ast.className) {
          ...
          case 'ExistsAssignOp':
            ...
            if (vars.length) {
              ...
              if (allReassign) {
                ...
                throw new Error('mixed reassign and initialisation in destructuring not currently supported');
              }
            }
          ...
          case 'NewOp':
            ...
            args = (function() {
              ...
              _results = [];
              for (i = _k = 0, _len2 = _ref10.length; _k < _len2; i = ++_k) {
                a = _ref10[i];
          ...
          case 'SoakedFunctionApplication':
            ...
            if (ast.className === 'FunctionApplication' && ast["arguments"].length === 0 && ((_ref10 = (_ref11 = options.ancestors[1]) != null ? _ref11.className : void 0) !== 'UnaryExistsOp' && _ref10 !== 'SoakedMemberAccessOp')) {
              return "" + _fn + "!";
            } else {
              args = (function() {
                var _k, _len2, _ref12, _results;
                _ref12 = ast["arguments"];
                _results = [];
                for (i = _k = 0, _len2 = _ref12.length; _k < _len2; i = ++_k) {
                  a = _ref12[i];
                  arg = generate(a, options);
          ...
          case 'SoakedDynamicProtoMemberAccessOp':
            ...
            if (ast.className === 'DynamicMemberAccessOp' && ((_ref12 = ast.indexingExpr.className) === 'String' || _ref12 === 'Int')) {
          ...
          case 'ForOf':
            ...
            if (type === 'of') {
              _ref14 = [_secondAssg, _firstAssg], _firstAssg = _ref14[0], _secondAssg = _ref14[1];
            }
            if (_secondAssg) {
            ...
            comprehension = false;
            _body = ast.body ? (comprehension = ((_ref15 = ast.body.statements) != null ? _ref15.length : void 0) === 1 && usedAsExpression && 'For' !== ast.body.statements[0].className.slice(0, 3), generate(ast.body, options)) : 'void';
