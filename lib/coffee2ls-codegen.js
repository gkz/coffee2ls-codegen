...
(function() {
  ...
  (function(exports) {
    var TAB, clone, eq, formatInterpolation, formatStringData, genVar, generate, generateArgs, generateComments, indent, levels, lsReserved, needsParensWhenOnLeft, operators, parens, precedence;
    TAB = '  ';
    ...
    return exports.generate = generate = function(ast, options) {
      var absNum, allNew, allReassign, c, comprehension, exp, expression_, finallyBody, findIds, firstRef, flag, generated, hasAlternate, i, isMultiline, key_, left, line, m, matched, memberAccessOps, members_, needsParens, newline, nonLiteral, out, output, p, parameters, parent, parentClassName, prec, reg, right, s, secondRef, sep, spaces, src, state, type, usedAsExpression, v, vars, _alternate, _argList, _args, _assg, _assignee, _base, _block, _body, _by, _catchAssg, _catchBody, _condition, _conditions, _consequent, _ctor, _expr, _expression, _exprs, _filter, _finally, _firstAssg, _flags, _fn, _fn_indented, _indexingExpr, _left, _main, _mainPart, _mid, _nameAssg, _op, _own, _paramList, _parent, _rangeLeft, _rangeRight, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _right, _s, _secondAssg, _step, _symbol, _target;
      if (options == null) {
        options = {};
      }
      if (!(ast != null)) {
            ...
            if (ast.statements.length === 0) {
              ...
              out = (function() {
                ...
                for (_i = 0, _len = _ref4.length; _i < _len; _i++) {
                  ...
                  _results.push("" + (generateComments(options.comments[0])) + generated);
                }
                return _results;
              })();
              options.comments.shift();
              out = out.join(sep);
              if (parentClassName === 'Program' && ast.comments) {
                out = generateComments(ast.comments) + out;
              }
              return out;
            }
      ...
      if (ast.comments && ast.comments.length) {
        if ((_ref4 = options.comments) == null) {
          options.comments = [];
        }
        if ((_ref5 = (_base = options.comments)[0]) == null) {
          _base[0] = [];
        }
