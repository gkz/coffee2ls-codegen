...
(function() {
  ...
  (function(exports) {
    ...
    return exports.generate = generate = function(ast, options) {
      var absNum, allNew, allReassign, c, comprehension, exp, expression_, finallyBody, findIds, firstRef, flag, hasAlternate, i, isMultiline, key_, left, m, memberAccessOps, members_, needsParens, nonLiteral, out, output, p, parameters, parent, parentClassName, prec, right, s, secondRef, sep, src, state, type, usedAsExpression, v, vars, _alternate, _argList, _args, _assg, _assignee, _block, _body, _by, _catchAssg, _catchBody, _condition, _conditions, _consequent, _ctor, _expr, _expression, _exprs, _filter, _finally, _firstAssg, _flags, _fn, _indexingExpr, _left, _main, _mainPart, _mid, _nameAssg, _op, _output, _own, _paramList, _parent, _rangeLeft, _rangeRight, _ref, _ref1, _ref2, _ref3, _right, _s, _secondAssg, _step, _symbol, _target;
      if (options == null) {
        options = {};
      }
      if (!(ast != null)) {
